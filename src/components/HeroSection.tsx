  ...
  return (
    <>
      ...
      >
        ...
        {/* HUD corners */}
        <div aria-hidden="true" className="pointer-events-none absolute top-20 left-6 select-none" style={{ fontFamily: "'DM Mono', monospace", fontSize: "9px", letterSpacing: "0.15em", color: "rgba(0,255,135,0.3)", lineHeight: 1.9 }}>
          <div>// SD_PORTFOLIO</div>
          <div>STATUS: ACTIVE</div>
        </div>
        <div aria-hidden="true" className="pointer-events-none absolute top-20 right-6 text-right select-none" style={{ fontFamily: "'DM Mono', monospace", fontSize: "9px", letterSpacing: "0.15em", color: "rgba(0,255,135,0.3)", lineHeight: 1.9 }}>
          <div>MUMBAI · IN</div>
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl">
          ...
          <motion.p
            ...
            style={{ color: "rgba(255,255,255,0.35)", fontFamily: "'DM Sans', sans-serif", fontWeight: 300 }}
          >
            {hero.subtitle}
          </motion.p>
            ...
            <div className="flex items-center gap-2 ml-1">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="flex h-10 w-10 items-center justify-center rounded-xl border border-[rgba(255,255,255,0.07)] text-[rgba(255,255,255,0.3)] transition-all hover:border-[rgba(0,255,135,0.35)] hover:text-[#00FF87] hover:bg-[rgba(0,255,135,0.06)]"
                >
        ...
        <motion.div
          ...
          style={{ fontFamily: "'DM Mono', monospace", fontSize: "9px", letterSpacing: "0.18em", color: "rgba(0,255,135,0.3)" }}
        >
