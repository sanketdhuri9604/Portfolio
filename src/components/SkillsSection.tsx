              ...
              >
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs" style={{ color: "rgba(255,255,255,0.80)" }}>{cat.desc}</p>
                  </div>
                </div>
                ...
                <ul className="flex flex-wrap gap-2" aria-label={`${cat.title} skills`}>
                  {cat.skills.map((s) => (
                    <motion.li key={s} whileHover={{ scale: 1.06 }}>
                      <span
                        className="inline-block rounded-xl border border-[rgba(0,255,135,0.2)] bg-[rgba(0,255,135,0.04)] px-3 py-1.5 text-xs font-medium cursor-default transition-all hover:border-[rgba(0,255,135,0.4)] hover:text-[#00FF87]" style={{ color: "rgba(0,255,135,0.92)" }}
